...
namespace Кликер.Forms
{
    partial class Achievements
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Купить первое улучшения инструмента";
			...
			this.label5.Text = "место для количества денег.";
			// 
			// check
			// 
			this.check.Enabled = true;
			this.check.Tick += new System.EventHandler(this.CheckUpdater);
			// 
			// Achievements
			// 
